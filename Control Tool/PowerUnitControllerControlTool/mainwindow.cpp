  ...
  ui(new Ui::MainWindow)
{
  ...
  QObject::connect(this->ui->actionLoadADC2Temp, SIGNAL(triggered(bool)), this, SLOT(MwSlotLoadADC2Temp()));
...
void MainWindow::MwSlotLoadADC2Temp()
{
  QString filepath = QFileDialog::getOpenFileName(this, QObject::trUtf8("Load ADC to Temperature settings"));
  if (filepath != "")
  {
    this->_tconv->LoadSettings(filepath);
    emit MwSignalConvertorChanged();
  }
}
