...
namespace Interfaces
{
	...
	class ISettingsStep : public QObject
	{
		...
		public:
			...
			/**
			 * @brief Returns "Off" if _CurrentRPM == 0, and string representation of GetCurrentRPMPercents() otherwise.
			 * @return "Off" or current RPMs as string with percents
			 */
			virtual QString GetCurrentRPMPercentsString() = 0;

			/**
			 * @brief Call it to set ADC delta value. If delta more than MAX_ADC_DELTA (defined in descendant) set it to MAX_ADC_DELTA,
